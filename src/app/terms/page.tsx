  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-16 lg:px-8">
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none">
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold">Project Showcase</h2>
          <p className="text-muted-foreground">
            Projects displayed on this website are for demonstration purposes only. Some projects
            may be proprietary work done for employers or clients. Unauthorized reproduction or use
            of these projects is prohibited.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-muted-foreground">
            ...
            express or implied. I do not warrant that the website will be uninterrupted, error-free,
        ...
        <section className="mb-8">
          ...
          <p className="text-muted-foreground">
            By using the contact form, you agree that your message may be stored and used to respond
            to your inquiry. Your information will be handled in accordance with the Privacy Policy.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold">Code Samples</h2>
          <p className="text-muted-foreground">
            Code samples and technical content on this website are provided for educational
            purposes. While I strive for accuracy, I make no guarantees about the correctness or
            suitability of any code for production use.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-muted-foreground">
            ...
            States and the Commonwealth of Virginia, without regard to conflict of law principles.
          </p>
        </section>
